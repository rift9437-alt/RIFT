...
const CABINETS = [
  ...
  { id:'robot', icon:'🤖', name:'Robot Arena', accent:'#7dd3ff',
    desc:"You're handed a bot built from random scrap. Every part carries stats, a rarity and often a drawback, and shooting one off takes what it was giving you. Win a round, draft one of three more.",
    tags:['solo','new'], screen:'robot-screen', mod:()=>RobotGame,
    stat:'Tracks · Best Round', best:{game:'robot', key:'bestRound', label:'ROUND'} },
  { id:'whodidit', icon:'🔍', name:'Who Did It?', accent:'#ffc857',
    desc:"Something's been taken from the arcade. Search rooms for evidence, question five suspects, and name the culprit before the clock runs out. Every case is generated fresh.",
    tags:['solo','new'], screen:'whodidit-screen', mod:()=>WhoDidItGame,
    stat:'Tracks · Cases Solved', best:{game:'whodidit', key:'solved', label:'SOLVED'} },
  ...
  { id:'avatar', icon:'🧍', name:'Your Avatar', accent:'#45ffb0',
    desc:"Build the character you play as. Same model shows up in the shared world and on the track, so everyone sees the one you made.",
    tags:[], screen:'avatar-screen',
    stat:'Dress up · Show off', onOpen:()=>openAvatarCreator() },
  { id:'tournaments', icon:'🏆', name:'Tournaments', accent:'#ffc857',
    desc:"Timed contests on a single cabinet. Entering records your score right then, so what counts is how far you climb — not where you started.",
    tags:[], screen:'tournaments-screen',
    stat:'Enter · Climb · Collect', onOpen:()=>openTournaments() },
  { id:'gazette', icon:'📰', name:'The Gazette', accent:'#e8dcc0',
    desc:"The arcade's own front page, written from whatever actually happened this week — plus the archive of what this building is.",
    tags:[], screen:'gazette-screen',
    stat:'Records · Rumours · Lore', onOpen:()=>openGazette() },
  { id:'clans', icon:'🛡', name:'Clans', accent:'#2de2c5',
    desc:"Found a clan or join one. A clan's score is the sum of its members' leaderboard points, so it moves when you play.",
    tags:[], screen:'clans-screen',
    stat:'Group up · Compete together', onOpen:()=>openClans() },
