...
const DEFAULT_WALLET = { tokens: 0, owned: ['neon'], equipped: 'neon', asteroidUpgrades: { extraLife: 0, turnSpeed: 0, autoTurret: 0 }, wildduelUpgrades: { extraHp: 0, fasterReload: 0, fasterMovement: 0 }, roguelikeUpgrades: { extraHp: 0, swordDamage: 0, magicPower: 0 } };
  ...
  USERS.forEach(u => {
    ...
    if (!w || typeof w !== 'object') {
      ...
      if (!w.roguelikeUpgrades || typeof w.roguelikeUpgrades !== 'object') {
        w.roguelikeUpgrades = { extraHp: 0, swordDamage: 0, magicPower: 0 };
      } else {
