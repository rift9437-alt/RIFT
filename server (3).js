...
const PASSWORD_HASHES = {
  ...
  "david12": "b2319aded73500e8b65b583768cb38e9:8e04075cb866021163f1d2854121672e15ffef5aaa3de51b805b0b9e7691cbcfa7559988b7c58213942922aac53803614698afaf67c397fbb3b03225029fe598"
};
...
const SHOP_ITEMS = {
  ...
  royal:  { name: 'Crown Jewels', cost: 200, cyan: '#2f9e56', pink: '#e8455f', gold: '#e8b923', bg: '#0d1410', bgPanel: '#121d15', bgPanelRaised: '#1a2a1e', border: '#254030' },
  ...
  zip: { name: 'Zip', cost: 3000, cyan: '#0f5c2d', pink: '#7a1f4d', gold: '#5e4508', bg: '#f3fff5', bgPanel: '#e4fbe9', bgPanelRaised: '#d3f5dc', border: '#a9e6bb', bgGradient: 'linear-gradient(135deg, #ffffff 0%, #d9f7e0 30%, #ffffff 55%, #bdf0c9 80%, #ffffff 100%)', cabinetBg: '#082714', cabinetText: '#f0fff4', cabinetTextDim: '#bfe8cc', text: '#0d2b16', textDim: '#2c5136', taunts: true },
  ...
  duo: { name: 'Yuta & Ryu', cost: 3000, cyan: '#6b8cff', pink: '#ff6bcb', gold: '#ffe08a', bg: '#140a22', bgPanel: '#1c1030', bgPanelRaised: '#261640', border: '#3a2456', bgGradient: 'linear-gradient(135deg, #3a1930 0%, #2b1a44 35%, #16233f 70%, #3a1930 100%)', buttonGradient: 'linear-gradient(135deg, #ff6bcb, #6b8cff)', taunts: true },
  ...
  uro: { name: 'Uro', cost: 3000, cyan: '#ff8fd6', pink: '#c9a6ff', gold: '#f2c14e', bg: '#1c0f1a', bgPanel: '#2a1526', bgPanelRaised: '#3a1c33', border: '#5c2a4c', bgGradient: 'linear-gradient(135deg, #3a1f34 0%, #2f1c3f 35%, #43203a 70%, #24101c 100%)', cabinetBg: '#4a1638', cabinetText: '#ffe6f7', cabinetTextDim: '#d9a8c9', text: '#f4e6f5', textDim: '#b98cae', taunts: true },
  ...
  trio: { name: 'Yuta, Ryu & Uro', cost: 8000, cyan: '#9a7dff', pink: '#ff6bcb', gold: '#ffe08a', bg: '#100a1c', bgPanel: '#1a1128', bgPanelRaised: '#241636', border: '#3a2456', bgGradient: 'linear-gradient(135deg, #16233f 0%, #35163a 33%, #2a1c42 66%, #3a1930 100%)', buttonGradient: 'linear-gradient(135deg, #6ea8ff, #ff6bcb, #c9a6ff)', taunts: true },
  ...
  beachwave: { name: 'Beach Wave', cost: 500, cyan: '#00c2d1', pink: '#ffb37a', gold: '#fff4d6', bg: '#052430', bgPanel: '#06222e', bgPanelRaised: '#0f4658', border: '#1c5f73', bgGradient: 'linear-gradient(135deg, #10333a 0%, #2b2a2c 25%, #05323f 60%, #042430 100%)', season: 1, limited: true },
  ...
  prism: { name: 'Prism Shift', cost: 500, cyan: '#ff5f6d', pink: '#7c4dff', gold: '#5bffea', bg: '#08060f', bgPanel: '#100c1c', bgPanelRaised: '#191228', border: '#281c3d', bgGradient: 'linear-gradient(135deg, #2a1420 0%, #1d1636 33%, #0f2b2c 66%, #2a1420 100%)' }
};
